<template>
  <div class="h-100 terms-main">
    <BContainer>
      ...
      <p>
        These terms and conditions outline the rules and regulations for the use of Adverpost's Website, located at
        adverpost.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use Adverpost if
      ...
      <h3>Cookies</h3>
      <p>
        We may employ the use of cookies. By accessing Adverpost, you agreed to use cookies in agreement with the
        Adverpost's Privacy Policy.
      </p>
      <p>
      ...
      <h3>License</h3>
      <p>
        Unless otherwise stated, Adverpost and/or its licensors own the intellectual property rights for all material
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            Sell, rent or sub-license material from Adverpost
            <ul>
              <li>Reproduce, duplicate or copy material from Adverpost</li>
              <li>Redistribute content from Adverpost</li>
            </ul>
          </li>
        </ul>
      </div>
      ...
      <p>
        ...
        areas of the website. Adverpost does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments and advertising contents displayed on screens with Adverpost do not reflect the views and
        opinions of Adverpost, its agents, customers and/or affiliates. Comments reflect the views and opinions of the
        person who post their views and opinions. To the extent permitted by applicable laws, Adverpost shall not be
      ...
      <p>
        ...
        <ul>
          <li>
            ...
            actions, have all necessary licenses and consents to do so;
          </li>
          <li>
            The Contents do not invade any intellectual property right, including without limitation copyright, patent
            or trademark of any third party;
          </li>
          <li>
            The Contents do not contain any defamatory, libelous, offensive, indecent or otherwise unlawful material
      ...
      <p>
        ...
        any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence
        of Adverpost; and (d) the link is in the context of general resource information.
      </p>
      <p>
      ...
      <p>
        ...
        you must inform us by sending an e-mail to Adverpost and receive written approval. Please include your name,
      ...
      <p>
        We shall not be hold responsible for any content that appears on Adverpost or our related Advertising Displays.
        You agree to protect and defend us against all claims that is rising from your use of Adverpost. No link(s),
        texts or images should appear on any contents you post that may be interpreted as libelous, obscene or criminal,
        or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party
        rights.
      </p>
      <h3>Your Privacy</h3>
      <p>Please read Adverpost Privacy Policy</p>
      <h3>Reservation of Rights</h3>
      <p>
        We reserve the right to request that you remove all contents, links or any particular link to our Website. You
        approve to immediately remove all links to our Website upon request. We also reserve the right to amend these
        terms and conditions and it’s linking policy at any time. By continuously using or linking to our Website, you
        agree to be bound to and follow these terms and conditions.
      </p>
      <h3>Removal of links from our website</h3>
      <p>
        If you find any link on our Website that is offensive or damaging for any reason, you are free to contact and
        inform us any moment. We will consider requests to remove links but we are not obligated to or so or to respond
        to you directly.
      </p>
      <p>
        We do not ensure that the information on Adverpost is correct, we do not warrant its completeness or accuracy;
      ...
      <p>
        As long as the Adverpost website and the information and services on the website are provided free of charge, we
