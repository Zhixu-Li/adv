  ...
  <div class="h-100 privacy-main">
    <BContainer>
      ...
      <p>
        ...
        visitors. This Privacy Policy document contains types of information that is collected and recorded by Adverpost
        and how we use it.
      </p>
      <p>
      ...
      <p>
        This Privacy Policy applies only to our online activities and is valid for our website users with regards to
        the information that they shared and/or collect in Adverpost. Our Privacy Policy was created with the help of
      ...
      <p>
        Any information that you are asked to provide, and the reasons why you are asked to provide it, will be made
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            ...
            provide you with services, updates and other information relating to the Adverpost, and for marketing and
      ...
      <p>
        Like any other website, Adverpost uses 'cookies'. These cookies are used to store information including
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Adverpost.</p>
      <p>
        Third-party ad servers or ad display networks may use technologies like cookies, JavaScript, or Web Beacons
        that are used in their respective advertisements and links that appear on Adverpost, which are sent directly to
      ...
      <p>
        Note that Adverpost has no access to or control over these cookies that are used by third-party advertisers.
      </p>
      <h3>Third Party Privacy Policies</h3>
      <p>
        Adverpost's Privacy Policy does not apply to other advertisers, display providers or websites. Thus, we are
      ...
      <p>
        Adverpost does not knowingly collect any Personal Identifiable Information from children under the age of 13.
